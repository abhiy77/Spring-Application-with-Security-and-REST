...
<body>
	...
	<div class="container">
		...
		<div class="row justify-content-center">
			...
			<!-- Registration Form -->
			<div class="col">
				<form:form action="${pageContext.request.contextPath}/registerAdmin"
					method="POST" class="form-horizontal" modelAttribute="admin">
					...
					<div class="row align-items-center">
						...
						<div class="input-group col-lg-8  mx-auto mb-4">
							<h4>
								<span class="badge badge-primary">Register as Admin</span>
							</h4>
						</div>
